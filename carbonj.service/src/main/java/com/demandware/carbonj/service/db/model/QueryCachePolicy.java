...
public class QueryCachePolicy
{
    ...
    final private boolean useTimeSeriesCacheFor60s90d;
    ...
    public QueryCachePolicy(boolean useTimeSeriesCacheFor60s24h,
                            ...
                            boolean useTimeSeriesCacheFor60s90d,
                            ...
                            boolean useTimeSeriesCacheFor30m2y)
    {
        ...
        this.useTimeSeriesCacheFor60s90d = useTimeSeriesCacheFor60s90d;
    ...
    public boolean useCache(RetentionPolicy p)
    {
        ...
        if (p.is60s90d()) {
            return useTimeSeriesCacheFor60s90d;
        }
