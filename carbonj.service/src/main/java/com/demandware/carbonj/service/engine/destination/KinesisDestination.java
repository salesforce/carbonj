        ...
        implements LineProtocolDestination
{
                              ...
                              Boolean kinesisRelayRbacEnabled, String kinesisRelayAccount, String kinesisRelayRole)
    {
        ...
        if ( kinesisRelayRbacEnabled )
        {
            ...
            kinesisClient = KinesisAsyncClient.builder()
                    .credentialsProvider( buildCredentialsProvider(kinesisRelayRegion, kinesisRelayAccount, kinesisRelayRole ) )
                    .region(Region.of(kinesisRelayRegion)).build();
        }
        else
        {
            log.info( "Rbac not enabled.  Building kinesis client.");
            kinesisClient = KinesisAsyncClient.builder().region(Region.of(kinesisRelayRegion)).build();
        }
    ...
    private static AwsCredentialsProvider buildCredentialsProvider(String kinesisRelayRegion, String kinesisRelayAccount, String kinesisRelayRole)
    {
        ...
        StsClient stsClient = StsClient.builder().region(Region.of(kinesisRelayRegion)).build();
